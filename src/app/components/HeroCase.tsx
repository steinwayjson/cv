...
export const HeroCase = memo(function HeroCase({ caseStudy }: HeroCaseProps) {
  return (
    <section
      ...
      style={{ maxHeight: "760px", background: "linear-gradient(135deg, #0f172a 0%, #1e293b 50%, #0f172a 100%)" }}
    >
      {/* Subtle radial glow */}
      <div
            ...
            {caseStudy.kpis.map((kpi, i) => (
              ...
              >
                <div className="mb-1.5 flex items-baseline gap-1.5">
                  <TrendingUp className="h-3.5 w-3.5 flex-shrink-0 text-emerald-400" style={{ position: "relative", top: "1px" }} />
