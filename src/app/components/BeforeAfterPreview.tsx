    ...
    <>
      <div className="space-y-3">
        ...
        >
          ...
          <button
            ...
            className="absolute bottom-3 right-3 z-20 flex items-center gap-1.5 rounded-lg bg-black/60 px-3 py-1.5 text-xs font-medium text-white backdrop-blur-sm transition-colors hover:bg-black/80"
            aria-label="Открыть полноразмерно"
          >
      ...
      {modal && (
        <ImageModal
          ...
          onNavigate={(index) => setModal({ index })}
        />
      )}
    </>
  );
