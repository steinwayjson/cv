...
export const personalInfo: PersonalInfo = {
  ...
  bio: "\nНахожу точки роста в воронке и реализую изменения, которые влияют на конверсию и экономику канала. Работаю на стыке маркетинга, аналитики и технической реализации — от гипотезы до внедрения и замера результата.",
  ...
  skillGroups: [
    ...
    },
    {
      ...
      items: ["WordPress / Tilda / Telegraf.js (боты) / квизы (разработка и доработка)", "Оптимизация конверсии сайта", "Настройка GTM и событийной аналитики", "Интеграция с CRM", "Реализация маркетинговых задач на сайте", "Работа с макетами (Figma)"],
    },
  ],
  approach: {
    principles: [
      "Рассматриваю маркетинг как систему: трафик → сайт → аналитика → CRM → обработка заявки",
      "Внедряю изменения через гипотезы и итерации — тест, замер, решение",
    ...
    expectations: [
      ...
      "Возможность влиять на юнит-экономику и масштабирование каналов",
    ],
  ...
  experience: [
    {
      ...
      period: "2024 — 2025",
      summary: "Маркетинговая команда застройщика (12 жилых комплексов). Фокус — рост эффективности органического канала при дорогом CPL.",
      bullets: [
        "Реализовал блог на WordPress, вёл посадочные на Tilda (~20 страниц) и квизы",
        "Переработал структуру сайта с фокусом на упрощение навигации и улучшение конверсии",
    ...
    },
    {
      ...
      bullets: [
        "Вёл клиентские проекты по привлечению трафика и конверсии сайтов",
        "Разработка и запуск воронок для инфопродуктов",
        "Осваивал техническую сторону маркетинга: вёрстка, JS, WordPress, Telegram-боты",
      ],
    },
    {
      company: "KleverLab",
